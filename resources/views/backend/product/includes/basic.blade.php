...
<div class="form-group">
  {!! Form::label('recommended_product','Recommended product',['class' => 'control-label']) !!}
  {!! Form::radio('recommended_product',1) !!}Active
  {!! Form::radio('recommended_product',0,true) !!}De-Active
</div>
<div class="form-group">
