...
class OrderStatusController extends BackendBaseController
{
    protected $panel = 'OrderStatus';    //for section/module
    protected $folder = 'backend.orderStatus.';   // for view file
    protected  $base_route = 'backend.orderStatus.';  // for route method
    protected  $title;
    protected $model;
